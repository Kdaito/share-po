...
export class UserApi extends runtime.BaseAPI {
  ...
  async getUserRaw(
    ...
    if (
      requestParameters.firebaseUid === null ||
      requestParameters.firebaseUid === undefined
    ) {
      throw new runtime.RequiredError(
        'firebaseUid',
        'Required parameter requestParameters.firebaseUid was null or undefined when calling getUser.'
      );
    }
    ...
    const response = await this.request(
      {
        path: `/user/{firebaseUid}`.replace(
          `{${'firebaseUid'}}`,
          encodeURIComponent(String(requestParameters.firebaseUid))
        ),
        method: 'GET',
        headers: headerParameters,
        query: queryParameters
